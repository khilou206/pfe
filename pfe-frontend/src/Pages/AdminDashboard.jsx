            ...
            {selectedProductDetails && (
                ...
                >
                    ...
                    >
                        <button 
                            onClick={() => setSelectedProductDetails(null)} 
                            style={{ position: 'absolute', right: '15px', top: '10px', border: 'none', background: 'none', fontSize: '20px', cursor: 'pointer' }}
                        >×</button>
                        ...
                        {selectedProductDetails.final_mockup && (
                            <img 
                                ...
                                alt="Final Product" 
                                style={{ width: '100%', borderRadius: '10px', marginBottom: '15px', border: '1px solid #ddd' }} 
                            />
                        )}
                     ...
                     {selectedProductDetails.design?.nom_design && (
                        <div style={{ marginTop: '15px' }}>
                            <a 
                                href={`http://127.0.0.1:8000/storage/logos/${selectedProductDetails.design.nom_design}`} 
                                download 
                                target="_blank" 
                                rel="noreferrer"
                                                    ...
                                                    {order.produits.map((p, index) => (
                                                        <div key={index} className="order-product-item" style={{ 
                                                            ...
                                                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                                                {/* Thumbnail + زر Voir Détails (من Code 2) */}
                                                                {p.final_mockup && (
                                                                    <img 
                        ...
                        <div className="add-mockup-section section-p1">
                            ...
                            <form className="admin-form" onSubmit={handleMockupSubmit} style={{ maxWidth: '600px', background: '#f4f4f4', padding: '20px', borderRadius: '10px' }}>
                                ...
                                <div className="input-group">
                                    ...
                                    <input 
                                        type="text" 
                                        name="categorie_mockup" 
                                        placeholder="مثال: T-shirts, Mugs, Accessories..." 
                                        required 
                                    />
                                </div>
                            ...
                            {/* ✅ زر يفتح واجهة التصميم (Designer Interface) */}
<div style={{ marginTop: '20px', borderTop: '1px solid #eee', paddingTop: '15px' }}>
    <button 
        ...
        style={{ 
            ...
            padding: '12px', 
            cursor: 'pointer', 
            backgroundColor: '#2ecc71', // لون أخضر كيدل على الإضافة/التعديل
            color: '#fff', 
            border: 'none', 
            borderRadius: '8px', 
            fontSize: '14px',
